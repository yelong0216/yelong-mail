...
public abstract class AbstractMail implements Mail {
	...
	// 创建一个邮件消息
	protected MimeMessage createMimeMessage(Sender sender, List<Recipient> recipients, Content mailContent)
	...
	protected Multipart createContentMultipart(Content mailContent)
